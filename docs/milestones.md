...
Código fuente que representa las entidades y objetos valor del dominio del problema para resolver la HU asociada (HU1), siguiendo las buenas prácticas según el lenguaje de programación usado, avanzando según la metodología de la asignatura y en específico la(s) propuesta(s) en el Objetivo 2.
